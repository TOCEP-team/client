...
const addNewLession = () => {
  ...
  return (
    <div className="col-span-5 max-w-[1440px] mx-auto">
      <h1 className="col-span-5 col-start-2 font-bold text-3xl underline text-gray-600"> Outline </h1>
      <a href={`/profile/${account}`} className="col-span-5 col-start-2 font-bold text-3xl underline text-gray-600"> View Course </a>
